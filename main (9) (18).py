...
async def start_command(client, message):
    ...
    welcome_text = """💫 Ultimate YouTube & Instagram Video Downloader 🚀
...
1. To download a video, simply send a YouTube, Instagram, or Facebook link.
2. The bot supports YouTube videos/Shorts, Instagram videos, and Facebook Reels.
...
async def download_button(client, message):
    is_admin = message.from_user.id == 7439517139
    await message.reply_text("Please send me a YouTube or Instagram video URL to download.", reply_markup=create_keyboard(is_admin=is_admin))
